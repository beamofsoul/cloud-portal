...
public class QTest extends EntityPathBase<Test> {
    ...
    private static final long serialVersionUID = 1420780660L;

    public static final QTest test = new QTest("test");

    public final com.moraydata.general.primary.entity.QBaseAbstractEntity _super = new com.moraydata.general.primary.entity.QBaseAbstractEntity(this);
